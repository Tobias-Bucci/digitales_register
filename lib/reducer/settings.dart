...
final settingsReducerBuilder = NestedReducerBuilder<AppState, AppStateBuilder,
  ...
  ..add(SettingsActionsNames.subjectNicksAutoGenerated,
      _subjectNicksAutoGenerated)
  ..add(
  ...
  ..add(SettingsActionsNames.showCalendarSubstituteBar, _calendarSubstituteBar)
...
void _subjectNicksAutoGenerated(
    SettingsState state, Action<bool> action, SettingsStateBuilder builder) {
  builder.subjectNicksAutoGenerated = action.payload;
}
...
void _calendarSubstituteBar(
    SettingsState state, Action<bool> action, SettingsStateBuilder builder) {
  builder.showCalendarSubstituteBar = action.payload;
}
